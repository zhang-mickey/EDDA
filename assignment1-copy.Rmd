...
**(a)** 
<!--Make some relevant plots of this data set, comment on normality. Investigate whether the columns Before and After8weeks are correlated.
--> 
...
We can use bootstrap method first as follows: The result may be slightly different for each bootstrap test.
We choose the maximum of the sample as the test statistic and set B as 1000.
```{r}
...
**(a)** Before we perform relevant ANOVA models,we need to check whether the data meets the necessary assumptions **ANOVA model** There are two main factors:Country and Related,we also include the interaction factor:County+Related.
